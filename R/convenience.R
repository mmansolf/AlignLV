...
#'                         ncores=3,estimator='lavaan.ordered',center.means=FALSE)
#' align.stack
...
#'                          ncores=3,estimator='mirt.grm',center.means=FALSE)
#' align.stack2
...
#' fit.align$fit
#' fit.align2$fit
#' (fit.align$fit%>%purrr::map(~.@ParTable%>%tibble::as_tibble%>%filter(free!=0))%>%
